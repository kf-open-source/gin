...
[![Build Status](https://github.com/kf-open-source/gin/workflows/Run%20Tests/badge.svg?branch=master)](https://github.com/kf-open-source/gin/actions?query=branch%3Amaster)
[![codecov](https://codecov.io/gh/gin-gonic/gin/branch/master/graph/badge.svg)](https://codecov.io/gh/gin-gonic/gin)
[![Go Report Card](https://goreportcard.com/badge/github.com/kf-open-source/gin)](https://goreportcard.com/report/github.com/kf-open-source/gin)
[![Go Reference](https://pkg.go.dev/badge/github.com/kf-open-source/gin?status.svg)](https://pkg.go.dev/github.com/kf-open-source/gin?tab=doc)
[![Sourcegraph](https://sourcegraph.com/github.com/kf-open-source/gin/-/badge.svg)](https://sourcegraph.com/github.com/kf-open-source/gin?badge)
[![Open Source Helpers](https://www.codetriage.com/gin-gonic/gin/badges/users.svg)](https://www.codetriage.com/gin-gonic/gin)
[![Release](https://img.shields.io/github/release/gin-gonic/gin.svg?style=flat-square)](https://github.com/kf-open-source/gin/releases)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/kf-open-source/gin)](https://www.tickgit.com/browse?repo=github.com/kf-open-source/gin)
...
```sh
import "github.com/kf-open-source/gin"
```

Alternatively, use `go get`:

```sh
go get -u github.com/kf-open-source/gin
```
...
See the [API documentation on go.dev](https://pkg.go.dev/github.com/kf-open-source/gin).
...
Here are some awesome projects that are using the [Gin](https://github.com/kf-open-source/gin) web framework.
